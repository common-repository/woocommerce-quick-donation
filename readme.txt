=== Quick Donation For WooCommerce ===
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't need to leave your web browser. To do an automatic install of Quick Donation For WooCommerce, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.

In the search field type "Quick Donation For WooCommerce"Â and click Search Plugins. Once you've found our eCommerce plugin you can view details about it such as the the point release, rating and description. Most importantly of course, you can install it by simply clicking "Install Now"
 ...
 * *via Admin Dashboard:* Go to 'Plugins > Add New', search for "Quick Donation For WooCommerce", click "install"
 * *OR via direct ZIP upload:* Upload the ZIP package via 'Plugins > Add New > Upload' in your WP Admin
 * *OR via FTP upload:* Upload `quick-donation-for-woocommerce` folder to the `/wp-content/plugins/` directory
...
Yes. Its Possible By Copying To Your Theme's Folder `wp-content/plugins/quick-donation-for-woocommerce/template/donation_form.php`
...
Please open an issue at <a href="https://github.com/varunsridharan/woocomerce-quick-donation/"> GitHub </a> and we will look into it
...
**I found a bug!**  
Oops. Please User github / WordPress to post bugs.  <a href="https://github.com/varunsridharan/woocomerce-quick-donation/"> Open an Issue </a>

**Quick Donation For WooCommerce is awesome! Can I contribute?**
Yes you can! Join in on our <a href="https://github.com/varunsridharan/woocomerce-quick-donation/">GitHub repository :)</a>
...
* **Fixed** - [Blank pages] (https://github.com/varunsridharan/woocomerce-quick-donation/issues/56)
* **Fixed** - [Latest version will not activate] (https://github.com/varunsridharan/woocomerce-quick-donation/issues/62)

= 1.3.7.1 =
* **Fixed** - Fixed Empty Trash Issue
* **Fixed** - [`T_PAAMAYIM_NEKUDOTAYIM` Critical: Update to latest kills admin area] (https://github.com/varunsridharan/woocomerce-quick-donation/issues/58) After Last UPDATE [1.3.7]
...
[#21](https://github.com/varunsridharan/woocomerce-quick-donation/issues/21),
[#23](https://github.com/varunsridharan/woocomerce-quick-donation/issues/23),
[#26](https://github.com/varunsridharan/woocomerce-quick-donation/issues/26),
[#27](https://github.com/varunsridharan/woocomerce-quick-donation/issues/27),
[#33](https://github.com/varunsridharan/woocomerce-quick-donation/issues/33),
[#34](https://github.com/varunsridharan/woocomerce-quick-donation/issues/34),
[#35](https://github.com/varunsridharan/woocomerce-quick-donation/issues/35),
[#38](https://github.com/varunsridharan/woocomerce-quick-donation/issues/38),
...
* **Fixes** - Fixed template override issue [https://github.com/varunsridharan/woocomerce-quick-donation/issues/12]
